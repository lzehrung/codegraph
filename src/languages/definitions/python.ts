...
export const PYTHON_DEF: LanguageDefinition = {
  ...
  structure: {
    blocks: [
      { type: "class_definition", nameQuery: "name: (identifier) @chunk.name", captureId: "class" },
      { type: "function_definition", nameQuery: "name: (identifier) @chunk.name", captureId: "function" },
      
      // Docstrings - only capture top-level module docstrings as standalone chunks
      { type: "expression_statement", nameQuery: "(string) @chunk.docstring", isBlock: false, parentType: "module" },
      
      // Top level assignments
      { type: "assignment", nameQuery: "left: (identifier) @chunk.name", captureId: "module_var" },
