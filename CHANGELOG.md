...
- Duplicate masking includes Ruby `load`/`autoload` and Zig `@cImport`, with native and fallback handling. Kotlin duplicate queries use the loaded grammar's `import` node.
