...
- Navigation and references include same-directory package/namespace peers, C# partial members, Swift extension members, and Zig imported functions. Lookup keeps unrelated declarations separate and reports partial coverage when compilation-unit membership cannot be established beyond the supported source boundary. Zig module exports now require `pub`.
