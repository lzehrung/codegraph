...
- Safe semantic rename: get a handle with `codegraph list-symbols`, preview with `codegraph refactor rename --symbol <handle> --to <name> --json`, then add `--apply` when the edit set is acceptable.
