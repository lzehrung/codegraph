...
- Deterministic agent search across files, symbols, chunks, SQL objects, and graph neighborhoods with stable follow-up handles.
...
- [docs/library-api.md](./docs/library-api.md): agent search, semantic chunking, indexing, graph APIs, read-only SQL, impact examples, and programmatic review output
