...
node ./dist/cli.js duplicates ./src --min-confidence medium --limit 20 --json
```
...
- Duplicate cleanup: run `codegraph duplicates ./src --min-confidence medium --json` before refactors to find shared extraction candidates.
