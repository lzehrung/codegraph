...
For absence claims, inspect `referenceCoverage`: it covers indexed candidates, not unknown dynamic imports. Import declaration hits label source and alias/default tokens in `via.importBinding`.
