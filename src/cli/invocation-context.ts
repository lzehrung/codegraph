...
type DiscoveryGlobHelpers = typeof import("./discovery-globs.js");
type ConfigHelpers = typeof import("../config.js");
type ProjectFilesHelpers = typeof import("../util/project-files.js");
type GitHelpers = typeof import("../util/git.js");
type IncludeRootsHelpers = typeof import("../util/include-roots.js");
...
function loadDiscoveryGlobHelpers(): Promise<DiscoveryGlobHelpers> {
  discoveryGlobHelpersPromise ??= import("./discovery-globs.js");
...
function loadProjectFilesHelpers(): Promise<ProjectFilesHelpers> {
  projectFilesHelpersPromise ??= import("../util/project-files.js");
...
function loadIncludeRootsHelpers(): Promise<IncludeRootsHelpers> {
  includeRootsHelpersPromise ??= import("../util/include-roots.js");
