...
| C                | passing | 36    | `tests/languages/c.test.ts`          |
| C#               | passing | 26    | `tests/languages/csharp.test.ts`     |
| C++              | passing | 36    | `tests/languages/cpp.test.ts`        |
...
| PHP              | passing | 57    | `tests/languages/php.test.ts`        |
