...
- **Dependency graph**
  ...
  - PHP: `require`, `require_once`, `include`, `include_once`, constant-foldable include paths like `__DIR__ . '/file.php'`, grouped `use` imports, fully-qualified class/static/type references, and Composer autoload metadata (`psr-4`, `autoload-dev`, `classmap`, `exclude-from-classmap`, `autoload.files`)
...
- **Go to definition**
  ...
  - PHP: Direct and `__DIR__` include edges, grouped `use` imports, fully-qualified class/static/type references, and Composer-aware namespace resolution
...
- **Find references**
  ...
  - Python: Module imports, `__all__` exports, relative imports
  - PHP: Direct and `__DIR__` include edges, grouped `use` imports, fully-qualified class/static/type references, and Composer-aware symbol resolution
