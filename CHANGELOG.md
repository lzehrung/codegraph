...
- C file-scope forward declarations reuse included tags, while block-scope forward declarations retain their own scope. Completed tags take precedence over incomplete declarations in exports and local lookup. Compact and detailed symbol graphs keep separate tag and ordinary-name include aliases, including a function that shares a tag's name.
