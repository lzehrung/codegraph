...
3. **Startup plan** (lazy dispatch, bundle, compile cache, and eager-trim shipped through
   Priority 3). Remaining cold win is mainly native fingerprint avoidance from the native plan.
   Priority 0–3 are implemented; further startup cuts should re-measure before more work.
