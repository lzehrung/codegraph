...
describe("Dependency Graph", () => {
  ...
  describe("JavaScript Project", () => {
    ...
    it("should detect CommonJS dependencies", async () => {
      ...
      const commonJSEdges = graph.edges.filter(
        (edge) =>
          edge.from.includes("legacy.js") ||
          toStr(edge.to).includes("legacy.js") ||
          edge.from.includes("mixed.js") ||
          toStr(edge.to).includes("mixed.js"),
      );
    ...
    it("should detect mixed module system dependencies", async () => {
      ...
      const mixedEdges = graph.edges.filter((edge) => edge.from.includes("mixed.js"));
