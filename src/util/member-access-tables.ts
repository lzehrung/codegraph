...
export const MEMBER_ACCESS_ROWS: Record<string, MemberAccessRow> = {
  ...
  csharp: {
    extraTraversalTypes: ["qualified_name", "alias_qualified_name"],
    extraMemberAccessTypes: ["alias_qualified_name"],
    memberAccessShapes: [
      {
        nodeTypes: ["alias_qualified_name"],
        object: { field: "alias", fallbackIndex: 0 },
        property: { field: "name", fallbackIndex: 2 },
      },
      { object: { index: 0 }, property: { index: 2 } },
    ],
