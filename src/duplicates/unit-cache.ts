...
import { lruMapGet } from "../util/lru-map.js";
...
// v8: Ruby load/autoload masking requires a complete literal argument, so concatenations stay in the unit.
export const DUPLICATE_UNIT_CACHE_VERSION = 8;
