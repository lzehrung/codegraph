...
Generated: 2026-09-21T01:46:56.030Z (Node v22.16.0)

Total across the 28 language suites: 457 tests, 0 failed.
...
| C++              | passing | 21    | `tests/languages/cpp.test.ts`        |
...
| TypeScript       | passing | 16    | `tests/languages/typescript.test.ts` |
