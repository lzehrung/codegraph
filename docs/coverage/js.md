...
Source: `coverage/js/lcov.info`

## Summary

| Metric    |   Hit | Found | Coverage |
| --------- | ----: | ----: | -------: |
| Lines     | 31087 | 34396 |   90.38% |
| Functions |  5119 |  5466 |   93.65% |
| Branches  | 23648 | 29819 |   79.31% |
...
| `src/languages/definitions/javascript.ts`       | 60.00% |    80.00% |   57.89% |
| `src/cli/explore.ts`                            | 62.50% |   100.00% |   50.00% |
| `src/languages/definitions/typescript.ts`       | 63.64% |    88.89% |   42.86% |
...
| `src/indexer/imports/language-specific.ts`      | 74.09% |   100.00% |   63.74% |
...
| `src/native/execution.ts`                       | 75.86% |    81.25% |   73.77% |
