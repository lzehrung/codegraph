...
- C# extension methods no longer count their `this` receiver as an argument of `value.M()`; `Ext.M(value)` still passes it explicitly. C# 11 `file` types are no longer visible to other files in the same namespace.
