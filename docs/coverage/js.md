...
| --- | ---: | ---: | ---: |
| `src/agent/query-index/queryIndexWorker.ts` | 0.00% | 0.00% | n/a |
...
| `src/cli/navigation.ts` | 64.55% | 59.26% | 64.56% |
| `src/cli/index.ts` | 66.67% | 100.00% | 58.97% |
| `src/agent/query-index/content.ts` | 66.67% | 62.50% | 71.79% |
| `src/indexer/parsed-cache.ts` | 66.67% | 100.00% | 58.33% |
