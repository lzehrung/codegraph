...
Generated: 2026-09-25T02:57:35.313Z (Node v22.16.0)

Total across the 28 language suites: 523 tests, 0 failed.
...
| C#               | passing | 36    | `tests/languages/csharp.test.ts`     |
...
| Swift            | passing | 12    | `tests/languages/swift.test.ts`      |
