...
- Implemented: benchmark harness with cold/warm full-index runs, graph-only runs, and a coarse cold-only CI smoke benchmark for native-vs-JS regression detection
