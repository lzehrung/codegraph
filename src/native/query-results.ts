...
import { stringIndexForByte, stringPositionForBytePoint, type ByteToStringIndexMap } from "./byte-index.js";
import type { NativeCapture, NativeMatch } from "./tree-sitter-native.js";
