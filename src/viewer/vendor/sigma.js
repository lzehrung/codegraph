...
var SIZE_FACTOR_PER_ATTRIBUTE_TYPE = _defineProperty(
  _defineProperty(
    _defineProperty(
      _defineProperty(
        _defineProperty(
          _defineProperty(
            _defineProperty(_defineProperty({}, WebGL2RenderingContext.BOOL, 1), WebGL2RenderingContext.BYTE, 1),
    ...
    if (this.isInstanced) {
      ...
      if (this.CONSTANT_DATA.length !== this.VERTICES)
        throw new Error(
          "Program: error while getting constant data (expected "
            .concat(this.VERTICES, " items, received ")
            .concat(this.CONSTANT_DATA.length, " instead)"),
        );
      ...
      for (var i = 0; i < this.CONSTANT_DATA.length; i++) {
        ...
        if (vector.length !== constantAttributesItemsCount)
          throw new Error(
            "Program: error while getting constant data (one vector has "
              .concat(vector.length, " items instead of ")
              .concat(constantAttributesItemsCount, ")"),
          );
...
function validateGraph(graph) {
  ...
  graph.forEachNode(function (key, attributes) {
    if (!Number.isFinite(attributes.x) || !Number.isFinite(attributes.y)) {
      throw new Error(
        "Sigma: Coordinates of node ".concat(key, " are invalid. A node must have a numeric 'x' and 'y' attribute."),
      );
    }
  });
}
...
function getMouseCoords(e, dom) {
  var res = _objectSpread2(
    _objectSpread2({}, getPosition(e, dom)),
    {},
    {
...
function getWheelCoords(e, dom) {
  return _objectSpread2(
    _objectSpread2({}, getMouseCoords(e, dom)),
    {},
    {
  ...
  _createClass(TouchCaptor2, [
    ...
    },
    {
      ...
      value: function handleMove(e) {
        ...
        this.hasMoved ||
          (this.hasMoved = touchesPositions.some(function (position, idx) {
...
var Sigma$1 = /* @__PURE__ */ (function (_TypedEventEmitter) {
  ...
  function Sigma2(graph, container) {
    ...
    for (var type in _this.settings.nodeProgramClasses) {
      _this.registerNodeProgram(
        type,
        _this.settings.nodeProgramClasses[type],
        _this.settings.nodeHoverProgramClasses[type],
      );
    }
  ...
  _createClass(Sigma2, [
    {
      ...
      value: function registerNodeProgram(key, NodeProgramClass, NodeHoverProgram) {
        ...
        this.nodeHoverPrograms[key] = new (NodeHoverProgram || NodeProgramClass)(
    ...
    },
    {
      ...
      value: function process() {
        ...
        var nullCameraMatrix = matrixFromCamera(
          nullCamera.getState(),
          dimensions,
        ...
        if (oldSettings) {
          ...
          if (
            ...
            for (var _type4 in settings.nodeProgramClasses) {
              if (
                settings.nodeProgramClasses[_type4] !== oldSettings.nodeProgramClasses[_type4] ||
                settings.nodeHoverProgramClasses[_type4] !== oldSettings.nodeHoverProgramClasses[_type4]
              ) {
                this.registerNodeProgram(
                  _type4,
                  settings.nodeProgramClasses[_type4],
                  settings.nodeHoverProgramClasses[_type4],
                );
              }
            }
    ...
    },
    {
      ...
      value: function renderLabels() {
        ...
        for (var i = 0, l = labelsToDisplay.length; i < l; i++) {
          ...
          var drawLabel =
            (nodeProgram === null || nodeProgram === void 0 ? void 0 : nodeProgram.drawLabel) || defaultDrawNodeLabel;
          drawLabel(
            context,
            _objectSpread2(
              _objectSpread2(
    ...
    },
    {
      ...
      value: function renderEdgeLabels() {
        ...
        for (var i = 0, l = edgeLabelsToDisplay.length; i < l; i++) {
          ...
          var drawLabel =
            (edgeProgram === null || edgeProgram === void 0 ? void 0 : edgeProgram.drawLabel) || defaultDrawEdgeLabel;
          drawLabel(
            context,
            _objectSpread2(
              _objectSpread2(
    ...
    },
    {
      ...
      value: function renderHighlightedNodes() {
        ...
        var render = function render2(node) {
          ...
          var drawHover =
            (nodeProgram === null || nodeProgram === void 0 ? void 0 : nodeProgram.drawHover) || defaultDrawNodeHover;
          drawHover(
            context,
            _objectSpread2(
              _objectSpread2(
    ...
    },
    {
      ...
      value: function killLayer(id) {
        ...
        if (this.webGLContexts[id]) {
          ...
          var gl = this.webGLContexts[id];
          (_gl$getExtension = gl.getExtension("WEBGL_lose_context")) === null ||
            _gl$getExtension === void 0 ||
    ...
    },
    {
      ...
      value: function refresh(opts) {
        var _this9 = this;
        var skipIndexation =
          (opts === null || opts === void 0 ? void 0 : opts.skipIndexation) !== void 0
        ...
        if (fullRefresh) {
          ...
          var nodes =
            ((_opts$partialGraph = opts.partialGraph) === null || _opts$partialGraph === void 0
              ? void 0
              : _opts$partialGraph.nodes) || [];
          ...
          var edges =
            (opts === null ||
            opts === void 0 ||
            (_opts$partialGraph2 = opts.partialGraph) === null ||
            _opts$partialGraph2 === void 0
              ? void 0
              : _opts$partialGraph2.edges) || [];
