...
describe("git-native project file discovery", () => {
  ...
  it("records git-list timing when Git listing times out before filesystem fallback", async () => {
    const root = await makeRepo("codegraph-discovery-git-timeout-timing-");
