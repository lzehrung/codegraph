...
- Call compatibility hints are initially JS/TS-family only. They compare changed callable arity with resolved callsites when parsing is high confidence, and they do not claim language-wide type checking, overload resolution, or support for non-JS/TS languages.
